...
'''
def obtain_summary(n_demonstrations, weights, wt_uniform_sampling, wt_vi_traj_candidates, visualize=False):
    ...
    for wt_candidate in wt_uniform_sampling:
        ...
        debugging_priors[wt_candidate.tostring()] = [1. / len(wt_uniform_sampling)]
    ...
    while demo_count < n_demonstrations and len(wt_vi_traj_candidates) > 0:
        ...
        for wt_candidate in wt_uniform_sampling:
            ...
            debugging_priors[wt_candidate.tostring()].append(normalized_prior)
