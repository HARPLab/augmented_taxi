...
class AugmentedTaxi2OOMDP(OOMDP):
    ...
    def visualize_trajectory_comparison(self, flag, trajectory, trajectory_counterfactual, marked_state_importances=None,
        ...
        from .taxi_visualizer import _draw_augmented_state
        visualize_trajectory_comparison(self, flag, trajectory, trajectory_counterfactual, _draw_augmented_state, marked_state_importances=marked_state_importances, scr_width=self.width*width_scr_scale, scr_height=self.height*height_scr_scale, mdp_class='augmented_taxi2')
