...
def obtain_test_environments(mdp_class, data_loc, mdp_parameters, weights, BEC_params, step_cost_flag, n_human_models, prior, posterior, pool, summary=None, use_counterfactual=True, visualize_test_env=False):
    '''
...
def precompute_counterfactual_constraints(data_loc, mdp_parameters, weights, BEC_params, step_cost_flag, BEC_depth, n_human_models_precomputed, pool):
    '''
