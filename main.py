        ...
        for test in preliminary_tests:
            ...
            if (human_feature_count == opt_feature_count).all():
                ...
                if wait_version:
                    ...
                    traj_comparison_dict = extract_mdp_dict(test_vi, test_mdp, opt_traj, test_mdp_dict, data_loc, normalized_opt_traj=normalized_opt_traj, normalized_human_traj=normalized_human_traj)
                    import json
